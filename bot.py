...
api = requests.get("https://editacodigo.com.br/index/api-whatsapp/KOkw3fULshU5Gjc1yUlSX5eEWoDMFbuV" ,  headers=agent, verify=False)
time.sleep(1)
api = api.text
api = api.split(".n.")
...
def bot():
    try:
        ...
        #CAPTURAR MENSAGEM
        todas_as_msg = driver.find_elements(By.CLASS_NAME,'_11JPr')
        ...
        #RESPONDER CLIENTE
        resposta = requests.get('http://localhost/whatauto/index.php?', params={'msg': msg, 'telefone': telefone_final, 'usuario': usuario}, headers=agent)
        time.sleep(1)
